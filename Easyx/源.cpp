...
void change_thread(void*)
{
	...
	while (1)
	{
		if (GetAsyncKeyState(VK_SPACE) & 0x8000)
		{
			...
			else if (global_change_thread == 1)
			{
				temp = 0;
			}
			else
...
void command_train_mode()
{
	...
	printf("50 seconds later ,we will open internet explorer and look at localhost:8097");
	Sleep(50000);
